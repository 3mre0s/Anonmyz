...
// ErrLabelExists is returned when a placeholder is already reserved in this
// request scope. Refusing the write prevents a random-label collision from
// overwriting the original value associated with that placeholder.
